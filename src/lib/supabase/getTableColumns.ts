...
export const CONTACTS_RAW_COLUMNS: TableColumn[] = [
  ...
  { name: 'follow_up_days', type: 'integer', nullable: true, displayName: 'Follow-Up Days' },
  { name: 'follow_up_date', type: 'date', nullable: true, displayName: 'Follow-Up Date' },
  { name: 'follow_up_recency_threshold', type: 'integer', nullable: true, displayName: 'Follow-Up Threshold (Days)' },
  ...
  { name: 'group_email_role', type: 'text', nullable: true, displayName: 'Group Email Role' },
  ...
  { name: 'intentional_no_outreach', type: 'boolean', nullable: true, displayName: 'Intentional No Outreach' },
  { name: 'priority', type: 'boolean', nullable: true, displayName: 'Priority', isEditable: true },
