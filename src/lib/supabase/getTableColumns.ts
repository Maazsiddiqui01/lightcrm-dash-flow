...
export const OPPORTUNITIES_RAW_COLUMNS: TableColumn[] = [
  ...
  { name: 'most_recent_notes', type: 'text', nullable: true, displayName: 'Most Recent Notes' },
  { name: 'ebitda', type: 'text', nullable: true, displayName: 'EBITDA' },
  { name: 'ebitda_in_ms', type: 'numeric', nullable: true, displayName: 'EBITDA In MS' },
  ...
  { name: 'investment_professional_point_person_1', type: 'text', nullable: true, displayName: 'Investment Professional Point Person 1' },
  { name: 'investment_professional_point_person_2', type: 'text', nullable: true, displayName: 'Investment Professional Point Person 2' },
  { name: 'deal_source_company', type: 'text', nullable: true, displayName: 'Deal Source Company' },
  { name: 'deal_source_individual_1', type: 'text', nullable: true, displayName: 'Deal Source Individual 1' },
