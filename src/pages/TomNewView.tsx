  ...
  const columns = useMemo(() => [
    {
      ...
      width: 180,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.deal_source_company),
    },
    {
      ...
      width: 180,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.deal_source_individual),
    },
    {
      key: 'lg_sector',
      label: 'LG Sector',
      width: 150,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.lg_sector),
    },
    {
      key: 'lg_focus_area',
      label: 'LG Focus Area',
      width: 180,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.lg_focus_area),
    },
    {
      ...
      width: 200,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.areas_of_specialization),
    },
    {
      key: 'lg_lead',
      label: 'LG Lead',
      width: 150,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.lg_lead),
    },
    {
      ...
      width: 160,
      sortable: true,
      render: (row: TomNewViewRow) => formatDate(row.most_recent_contact),
    },
    {
      key: 'delta',
      label: 'Delta',
      width: 100,
      sortable: true,
      render: (row: TomNewViewRow) => formatNumber(row.delta),
    },
    {
      key: 'delta_type',
      label: 'Delta Type',
      width: 120,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.delta_type),
    },
    {
      key: 'no_of_emails',
      label: 'No of Emails',
      width: 120,
      sortable: true,
      render: (row: TomNewViewRow) => formatNumber(row.no_of_emails),
    },
    {
      key: 'no_of_meetings',
      ...
      width: 130,
      sortable: true,
      render: (row: TomNewViewRow) => formatNumber(row.no_of_meetings),
    },
    {
      ...
      width: 200,
      sortable: true,
      render: (row: TomNewViewRow) => formatDate(row.next_scheduled_outreach_date),
    },
    {
      key: 'deal_name',
      label: 'Deal Name',
      width: 180,
      sortable: true,
      render: (row: TomNewViewRow) => formatCell(row.deal_name),
    },
    {
      key: 'has_opps',
      label: 'Has Opps',
      width: 100,
      sortable: true,
      render: (row: TomNewViewRow) => row.has_opps === 'Yes' ? 'Yes' : row.has_opps === 'No' ? 'No' : '—',
    },
  ], []);
