-- Fix interaction import error by removing legacy group recalculation logic
-- The sync_group_interaction_dates trigger handles this correctly using group_id
...
BEGIN
  ...
  -- Note: Group date recalculation is now handled by sync_group_interaction_dates trigger
  -- which uses the new many-to-many group membership system
