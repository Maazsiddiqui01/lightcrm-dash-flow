-- LG Focus Areas Master List and Data Migration

-- First, add new focus areas to the master list
INSERT INTO lg_focus_area_master (focus_area, sector, is_active) VALUES
('A&D', 'Various', true),
('Food Manufacturing', 'Consumer', true),
('HC: (All)', 'Healthcare', true), -- Special filter for all HC focus areas
('Industrial Services', 'Industrial', true),
('Industrial Technology', 'Technology', true),
('Insurance Services / Wealth Management', 'Financial Services', true),
('Life Sciences', 'Healthcare', true),
('Electronic Components', 'Technology', true),
('Engineering Services', 'Industrial', true),
('HC: Services (Clinical)', 'Healthcare', true),
('Distribution', 'Various', true),
('HC: Services (Non-Clinical)', 'Healthcare', true)
ON CONFLICT (focus_area, sector) DO NOTHING;
